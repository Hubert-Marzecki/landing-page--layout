      ...
      <section className="hero__section flex flex-wrap" data-aos="fade-up">
        <div className="w-8/12 md:w-6/12">
          ...
          <div className="buttons__holder flex flex-wrap sm:flex-nowrap">
            <button className="pl-6 button__reservation flex flex-row items-center" onMouseEnter={() => setIsReservationHovered(true)} onMouseLeave={() => setIsReservationHovered(false)}>
              Zarezerwuj termin <div className="button__element ml-4  h-full items-center flex align-center justify-center "> <span className="oval"> <span className={ isReservationHovered ? " inside-oval inside__oval-grow" : "inside-oval"   } > </span> </span>  </div>
            </button>
